...
void OLED_SelectROM(oled_rom_t oledROM){
    ...
    SPI1_Exchange8bit(0b11111010);
    Send(oledROM == ROMA ? 0x00 : oledROM == ROMB ? 0x04 : 0x08);
    SPI1_Exchange8bit(0b11111000);
    Send(0x38);
...
static void Send(uint8_t data){
    ...
    SPI1_Exchange8bit(data&0xF0);
    SPI1_Exchange8bit((data<<4)&0xF0);
}
