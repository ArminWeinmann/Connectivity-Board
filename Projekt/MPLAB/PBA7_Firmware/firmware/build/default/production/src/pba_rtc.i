...
# 54 "src/../inc/../mcc_generated_files/mcc.h" 2
...
# 44 "src/pba_rtc.c" 2
# 54 "src/pba_rtc.c"
static __attribute__((inline)) uint8_t BcdToBinary(uint8_t numberBCD);
static __attribute__((inline)) uint8_t BinaryToBcd(uint8_t binaryValue);
...
void RTC_Init(void){
    ...
    I2C2_MasterWrite(data,2,0b01101000,&i2cWflag);
...
uint8_t RTC_GetSeconds(void){
    ...
    uint8_t data = 0x00;
    I2C2_MasterWrite(&data,1,0b01101000,&i2cWflag);
    while(i2cWflag!=I2C2_MESSAGE_COMPLETE);
    I2C2_MasterRead(&data,1,0b01101000,&i2cWflag);
    while(i2cWflag!=I2C2_MESSAGE_COMPLETE);
...
uint8_t RTC_IsTempConvDone(void){
    I2C2_MESSAGE_STATUS i2cWflag = I2C2_MESSAGE_PENDING;
    uint8_t data[2] = {0x0E,0x00};
    I2C2_MasterWrite(&data[0],1,0b01101000,&i2cWflag);
    while(i2cWflag!=I2C2_MESSAGE_COMPLETE);
    I2C2_MasterRead(&data[1],1,0b01101000,&i2cWflag);
    while(i2cWflag!=I2C2_MESSAGE_COMPLETE);
    if((data[1]&0x20)==0)
        return 1;
    else
